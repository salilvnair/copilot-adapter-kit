...
const SUITES = ['spend-guard.test.js', 'webview-host.test.js', 'message-contract.test.js', 'audit-db.test.js', 'status-bar.test.js', 'status-menu.test.js', 'packaging.test.js'];
